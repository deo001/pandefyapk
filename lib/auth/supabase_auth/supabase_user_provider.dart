...
class PandefySupabaseUser extends BaseAuthUser {
  PandefySupabaseUser(this.user);
  User? user;
  @override
...
Stream<BaseAuthUser> pandefySupabaseUserStream() {
  ...
  return (!loggedIn
      ...
      .map<BaseAuthUser>(
    (authState) {
      currentUser = PandefySupabaseUser(authState?.session?.user);
      return currentUser!;
    },
  );
}
